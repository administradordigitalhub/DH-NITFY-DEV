...
<body class="out-quart">
                              ...
                              <div class="d-grid gap-2 pt-4 pt-md-0">
                                 <div class="row g-1 rounded-3 overflow-hidden">
                                    <div class="col-6 mt-0">
                                       <img class="img-fluid" src="./assets/img/megamenu/img-1.jpg" alt="thumbnails"
                                          loading="lazy">
                                    </div>
                                    <div class="col-6 mt-0">
                                       <img class="img-fluid" src="./assets/img/megamenu/img-3.jpg" alt="thumbnails"
                                          loading="lazy">
                                    </div>
                                    <div class="col-6">
                                       <img class="img-fluid" src="./assets/img/megamenu/img-2.jpg" alt="thumbnails"
                                          loading="lazy">
                                    </div>
                                    <div class="col-6">
                                       <img class="img-fluid" src="./assets/img/megamenu/img-4.jpg" alt="thumbnails"
                                          loading="lazy">
                                    </div>
                                 </div>
                              ...
                              <ul class="mininav-content nav collapse">
                                 ...
                                 <li class="nav-item has-sub">
                                    ...
                                    <ul class="mininav-content nav collapse">
                                       <li data-popper-arrow class="arrow"></li>
                                       <li class="nav-item">
                                          <a href="../views/moduloCandidatos/forms-wizard.html" class="nav-link">Crear Candidato</a>
                                       </li>
                                       <li class="nav-item">
                                          <a href="../views/moduloCandidatos/tables-tabulator.html" class="nav-link">Resumen de Candidatos</a>
                                       </li>
                                    </ul>
                                    <!-- Fin del nuevo tercer nivel de submenú -->
                                 </li>
   ...
   <div id="_dm-settingsContainer" class="_dm-settings-container offcanvas offcanvas-end rounded-start" tabindex="-1">
      <button id="_dm-settingsToggler"
         class="_dm-btn-settings btn btn-sm btn-danger p-2 rounded-0 rounded-start shadow-none" type="button"
         data-bs-toggle="offcanvas" data-bs-target="#_dm-settingsContainer" aria-label="Customization button"
         aria-controls="#_dm-settingsContainer" disabled>
            ...
            <div class="col-lg-3 p-4">
               ...
               <div class="d-flex align-items-center pt-1 pb-3 mb-2">
                  <select id="_dm-transitionSelect" class="form-select" aria-label="select transition timing">
                     ...
                     <option value="jumping" selected>Jumping</option>
               ...
               <div class="text-nowrap">
                  <button type="button" class="_dm-offcanvasBtn btn btn-sm btn-primary"
                     value="offcanvas-top">Top</button>
                  <button type="button" class="_dm-offcanvasBtn btn btn-sm btn-primary"
                     value="offcanvas-end">Right</button>
                  <button type="button" class="_dm-offcanvasBtn btn btn-sm btn-primary"
                     value="offcanvas-bottom">Btm</button>
                  <button type="button" class="_dm-offcanvasBtn btn btn-sm btn-primary"
                     value="offcanvas-start">Left</button>
               </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="_dm-colorShcemesMode">
                           ...
                           <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                              ...
                              <img src="./assets/img/color-schemes/fair-header.png" alt="color scheme illusttration"
                                 loading="lazy">
                           </button>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="_dm-colorShcemesMode">
                           ...
                           <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                              ...
                              <img src="./assets/img/color-schemes/full-header.png" alt="color scheme illusttration"
                                 loading="lazy">
                           </button>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="_dm-colorShcemesMode">
                           ...
                           <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                              ...
                              <img src="./assets/img/color-schemes/navigation.png" alt="color scheme illusttration"
                                 loading="lazy">
                           </button>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="_dm-colorShcemesMode">
                           ...
                           <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                              ...
                              <img src="./assets/img/color-schemes/brand.png" alt="color scheme illusttration"
                                 loading="lazy">
                           </button>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="_dm-colorShcemesMode">
                           ...
                           <button type="button" class="_dm-colorModeBtn btn p-1 shadow-none"
                              ...
                              <img src="./assets/img/color-schemes/tall-header.png" alt="color scheme illusttration"
                                 loading="lazy">
                           </button>
